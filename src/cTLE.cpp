...
void cTle::Initialize()
{
   ...
   if (m_strName.empty()) throw SatTleNameEmpty_Exception();
   if (m_strLine1.empty()) throw SatTleLine1Empty_Exception();
   if (m_strLine2.empty()) throw SatTleLine2Empty_Exception();
